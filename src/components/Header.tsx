...
const Header: React.FC<HeaderProps> = ({ openContactPopup }) => {
  ...
  return (
    <header className={`fixed w-full top-0 left-0 z-50 transition-all duration-300 ${isScrolled ? 'bg-white shadow-md py-3' : 'bg-white bg-opacity-95 py-4'
      }`}>
          ...
          <div className="flex items-center">
            <a href="#home" className="text-xl font-bold text-gray-900 flex items-center">
              <span className="text-2xl font-bold flex flex-col">
                ZippStor<span className="text-xs text-gray-600 font-normal">Leading the Way in Retail-as-a-Service in India</span>
              </span>
            </a>
          </div>
